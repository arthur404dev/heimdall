          ...
          <div className='flex items-center gap-2 hover:cursor-pointer hover:text-gray-700 text-gray-500'>
            <div className='w-8 h-8 relative'>
              <Image
                ...
                layout='fill'
                objectFit='cover'
                src='/images/valknut.png'
              />
            </div>
            <span className='self-center font-sans text-2xl font-bold whitespace-nowrap'>
              Heimdall
            </span>
          </div>
        </Link>
          ...
          {status === "authenticated" ? (
            <div className='flex items-center gap-4'>
              <div className='flex items-center gap-2'>
                ...
                <h1 className='font-bold font-sans capitalize'>{`${data.user?.name}`}</h1>
              </div>
              <button
